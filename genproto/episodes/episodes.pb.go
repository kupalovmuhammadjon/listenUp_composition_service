...
var file_episodes_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0xb6, 0x02, 0x0a,
...
var file_episodes_proto_depIdxs = []int32{
	...
	2, // 7: episodes.EpisodesService.CreatePodcastEpisode:output_type -> episodes.ID
	4, // 8: episodes.EpisodesService.GetEpisodesByPodcastId:output_type -> episodes.Episodes
	5, // 9: episodes.EpisodesService.UpdateEpisode:output_type -> episodes.Void
	5, // 10: episodes.EpisodesService.DeleteEpisode:output_type -> episodes.Void
	8, // 11: episodes.EpisodesService.PublishPodcast:output_type -> episodes.Success
